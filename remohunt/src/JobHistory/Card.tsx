...
import { IconBookmarkFilled,IconBookmark, IconClockHour3 ,IconCalendarMonth } from "@tabler/icons-react";
...
const Card =(props:any)=>{
    return(
        ...
        <div className="flex justify-between">
            ...
            {
                props.saved?<div className="text-mine-shaft-300 cursor-pointer "><IconBookmarkFilled className="text-bright-sun-400" stroke={2} /></div>:
